		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#helpefastentryso-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"helpefastentryso-display": {
								"semanticObject": "helpefastentryso",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=helpe.fastentryso",
									"url": sap.ui.require.toUrl("helpe/fastentryso")
								}
							}
						}
					}
