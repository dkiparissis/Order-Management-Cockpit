		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fast Entry Tool For Sales Order",
									"targetURL": "#helpefastentrysol-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"helpefastentrysol-display": {
								"semanticObject": "helpefastentrysol",
								"action": "display",
								"description": "Fast Entry Tool For Sales Order Application",
								"title": "Fast Entry Tool For Sales Order",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=helpe.fastentrysol",
									"url": sap.ui.require.toUrl("helpe/fastentrysol")
								}
							}
						}
					}
